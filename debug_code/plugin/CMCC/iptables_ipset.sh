...
cmd="ip address add 172.19.66.1/16 dev $netcard"
check_success
...
cmd="iptables -t mangle -I PREROUTING -p tcp -m multiport --dport 8801,8802,1719,1720,5061,5062,5063,5064 -j MARK --set-mark 0x6"
check_success
...
check_success
cmd="ip6tables -I INPUT -p udp --dport 53 -j REJECT"
check_success
