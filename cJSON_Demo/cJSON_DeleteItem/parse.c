...
void Delete_Json_Item2(cJSON *c)
{
    while (c)
    {
        cJSON_DeleteItemFromObject(c, "country");
        cJSON_DeleteItemFromObject(c, "code_night");
        cJSON_DeleteItemFromObject(c, "text_night");
        cJSON_DeleteItemFromObject(c, "text_day");
